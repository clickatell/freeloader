...
public class TestMTCallbackReceiver implements ClickMessageHandler{
	public static int MAX_LOG_EPS = 3;
	static Logger log = Logger.getLogger("MTCallbackReceiver");
	...
	public TestMTCallbackReceiver(Properties props) {
		properties = props;
		int port = getPropAsInt("port", 8001);
		String path = getProp("url_path", "/http/mt_callback");
